        ...
        <form action="" className="my-10">
            <div className="flex flex-col space-y-5">
                ...
                {/* <div className="flex flex-row justify-between">
                    <div>
                        <label htmlFor="remember" className="">
                            <input type="checkbox" id="remember" className="w-4 h-4 border-slate-200 focus:bg-sky-600"/>
                            Remember me
                        </label>
                    </div>
                    <div>
                        <a href="#" className="font-medium text-sky-600">Forgot Password?</a>
                    </div>
                </div> */}
                ...
                <Link href={`signup${
                    ...
                    <p className="text-center">Not registered yet? <a href="#" className="text-sky-600 font-medium inline-flex space-x-1 items-center"><span>Register now </span><span><svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
